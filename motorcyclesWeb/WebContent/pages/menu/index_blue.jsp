...
<frameset frameborder=0 cols="100%" rows="112px,*">
	<frame name="frame_head" src="/motorcyclesWeb/pages/menu/head_blue.jsp" />
	<frameset cols="222px,*" rows="100%">
		<frame name="frame_menu"   style="border:0px solid gray; " height="100%" src="/motorcyclesWeb/pages/menu/menu_blue.jsp" />
