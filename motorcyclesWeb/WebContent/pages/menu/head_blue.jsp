	...
	<div class="headwrap">
    	<div class="row">
        	<div class="brand span4">
            	<img src="/motorcyclesWeb/images/logo2.png" >
            </div>
            
            <div class="span8 user"  style="margin-right:4%;">
            	<div class="font14"><img src="/motorcyclesWeb/images/icon-user.jpg" alt="">ชื่อผู้ใช้งาน <span class="text_white"><%=userDeatil.getUserName() %>&nbsp;&nbsp;<%=userDeatil.getUserSurname() %></span></div>
